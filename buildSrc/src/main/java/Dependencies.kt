object Dependencies {
    ...
    const val BARISTA = "com.github.AdevintaSpain:Barista:v${Versions.BARISTA}"
    ...
    const val TEST_ESPRESSO_CONTRIB = "androidx.test.espresso:espresso-contrib:${Versions.TEST_ESPRESSO_CORE}"
